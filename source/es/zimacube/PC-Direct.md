...
permalink: /es/zimacube/pc-direct.html
---
...
{% note warn Tips: %}
Si encuentras algún problema al utilizar Thunderbolt, puedes obtener información más detallada [aquí](/zimacube/Thunderbolt-connection-problem)
{% endnote %}
