---
title: Redes
description: ZimaOS no tiene interfaz de escritorio, conecta el cable Ethernet y estará listo. La pantalla conectada muestra la información del dispositivo y las direcciones IP, mientras que el panel permite ver las velocidades de enlace de cada puerto, cambiar a una IP estática o habilitar el acceso remoto.
type: “Docs”
...
De forma predeterminada, ZimaOS obtiene una dirección IP automáticamente mediante DHCP: solo conecta el cable Ethernet y el dispositivo estará listo. Si necesitas cambiar la configuración de red, abre el panel y ve a **Settings > Network**.
...
Esto facilita comprobar que cada puerto está negociando a la velocidad esperada y que ha recibido una IP válida de tu router.
...
El cambio tiene efecto inmediato. Si la nueva IP está en una subred diferente, tu sesión actual del panel se desconectará; usa la nueva IP mostrada en el monitor conectado para volver a conectarte.
...
Para más detalles, consulta [Remote Access](https://www.zimaspace.com/docs/zimaos/remote-access).
