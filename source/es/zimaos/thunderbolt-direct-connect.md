...
description: "Conecta ZimaCube directamente a tu Mac o PC mediante un cable Thunderbolt para alcanzar velocidades de transferencia de 2GB/s. Guía del modo PC Direct por Thunderbolt en ZimaOS."
type: "Docs"
...
## Mac
- Si aún no te has conectado a ZimaCube mediante ZimaClient, consulta la [documentación](./features#Download-the-Zima-Client) para descargar e instalar [ZimaClient](https://www.zimaspace.com/zimaos/download). ZimaClient dará prioridad a los dispositivos conectados por Thunderbolt durante el escaneo inicial.
...
2. Después de enchufar el cable, ZimaClient se adaptará automáticamente y cambiará a la conexión Thunderbolt.
   - Si aún no te has conectado a ZimaCube mediante ZimaClient, consulta la [documentación](./features#Download-the-Zima-Client) para descargar e instalar [ZimaClient](https://www.zimaspace.com/zimaos/download).
...
## Lectura Extendida
  1. Para acceder y modificar archivos de ZimaCube en Finder de macOS y el Explorador de Windows, consulta [más información](./samba-member-setup).
  2. Para conocer las velocidades máximas de transferencia mediante Thunderbolt en ZimaCube, consulta el [análisis de velocidades de transferencia de la conexión Thunderbolt de ZimaCube](../hardware/transfer-speeds-over-thunderbolt).
