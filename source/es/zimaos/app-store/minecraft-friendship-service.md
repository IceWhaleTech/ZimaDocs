...
![minecraft-casa-home-page](/images/Minecraft-Friendship-Service/minecraft-introduce-home-page.webp)
...
Por defecto, ya sabes cómo usar ZimaBoard al leer este tutorial: [**Tutorial de ZimaBoard**](../../../hardware/zimaboard-quick-start)
...
![Copia Minecraft Server Cli](/images/Minecraft-Friendship-Service/minecraft-copy-cli.webp).

## Verifica el entorno

![Verifica el entorno del servidor de Minecraft](/images/Minecraft-Friendship-Service/minecraft-check-environment.webp)
...
![](/images/Minecraft-Friendship-Service/minecraft-open-minecraft-client.webp)

## Haz clic en Multijugador ##

![Abrir cliente de Minecraft](/images/Minecraft-Friendship-Service/minecraft-click-multiplayer.webp)
...
Si no conoces tu dirección IP, puedes consultar el tutorial—["**Encuentra tu dirección IP de CasaOS**"](../../../help-center/find-ip-address)
...
![Mostrar página del juego de Minecraft](/images/Minecraft-Friendship-Service/minecraft-show-minecraft-game-page.webp)
