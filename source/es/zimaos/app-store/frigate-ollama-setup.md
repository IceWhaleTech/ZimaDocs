...
Utilizada para acelerar localmente la inferencia de modelos de IA (como las tarjetas gráficas de la serie NVIDIA). Consulta la [guía de ampliación de GPU](../../hardware/gpu-expansion).  
