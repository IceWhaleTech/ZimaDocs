...
![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-docker-cli.webp)
...
![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps1.webp)

![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps2.webp)

![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps3.webp)

![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps4.webp)

## Copiar la CLI de Docker de la API de Apprise 

![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps5.webp)

## Pegar la CLI de Docker de la API de Apprise 

![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps6.webp)

## Agregar Puerto de Web UI

![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps7.webp)

## Esperar a la Instalación

Esto puede tardar unos minutos

![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps8.webp)

## Instalación Exitosa y Clic para Usar

![Copiar Appriseapi Cli](/images/Self-Deploying-Applications/application-using-appriseapi.webp)
