...
Si descubres que **`/casaos.local`** no puede acceder a CasaOS, por favor utiliza la dirección IP para acceder al sistema -[Tutorial para encontrar la dirección IP](../../../help-center/find-ip-address)
