...
Instala la memoria, conecta el cable Ethernet y los cables de video al ZimaBlade. Para una guía detallada paso a paso sobre cómo instalar la memoria y otros componentes en ZimaBlade, consulta este tutorial completo: [Configura un NAS con ZimaBlade](../../../hardware/power-on-zimablade).
