---
title: PC Direct
seo_title: "ZimaCube PC Direct: conexión mediante cable Thunderbolt"
description: "Conecta ZimaCube directamente al PC mediante Thunderbolt o 10GbE para transferir archivos locales a gran velocidad. Guía para configurar el modo PC Direct sin router."
type: Docs
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---
## Una forma diferente de configurar el dispositivo
...
{% note warn Tips: %}
Si encuentras algún problema al utilizar Thunderbolt, puedes obtener información más detallada [aquí](../help-center/thunderbolt-connection-problem)
{% endnote %}
...
* Para Windows/Mac, se necesita una [APP de Zima](https://www.zimaspace.com/zimaos/download) 5 con Zerotier integrado.
**Pasos:**
