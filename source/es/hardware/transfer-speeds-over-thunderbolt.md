...
Asegúrese de haber consultado [Cómo conectar ZimaCube a través de un cable Thunderbolt](../../zimaos/thunderbolt-direct-connect).

## Transferencias de Alta Velocidad a través del Puente de Red Thunderbolt

### 1. Transferencias a través del Puente de Red Samba
Asegúrese de haber consultado el archivo de ayuda - [Samba con Multi-Usuario](../../zimaos/samba-member-setup).
