...
请确保您已参考[如何通过Thunderbolt电缆连接ZimaCube](../../zimaos/thunderbolt-direct-connect)。

## 通过Thunderbolt网络桥进行高速传输

### 1. Samba网络桥传输
确保您已参考帮助文件 - [与多用户使用Samba](../../zimaos/samba-member-setup)。
...
## 如果您的传输速度未达到预期
如果您使用Thunderbolt连接进行文件传输的速度未能达到上述标准，建议您参考本文最后的常见问题帮助文档 - [如何通过Thunderbolt电缆连接ZimaCube](../../zimaos/thunderbolt-direct-connect)。通过遵循故障排除指南中的步骤，您可以进一步优化传输性能，确保获得最佳的文件传输速度体验。