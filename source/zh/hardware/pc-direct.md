---
title: PC 直连
seo_title: "ZimaCube PC 直连：通过 Thunderbolt 线缆连接"
description: "通过 Thunderbolt 或 10GbE 将 ZimaCube 直接连接到电脑，实现高速本地文件传输。本指南介绍无需路由器的 PC 直连模式设置。"
type: Docs
...
{% note warn 提示: %}
如果在使用 Thunderbolt 时遇到问题，可在[这里](../help-center/thunderbolt-connection-problem)获取更详细的信息。
{% endnote %}
...
* Windows/Mac 需要使用集成 Zerotier 的 [Zima APP](https://www.zimaspace.com/zimaos/download) 5。
**步骤：**
