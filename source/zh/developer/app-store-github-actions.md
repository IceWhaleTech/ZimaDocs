---
title: 应用商店 GitHub Actions
seo_title: "使用 GitHub Actions 构建 ZimaOS Docker 应用商店"
description: "复用官方 GitHub Actions，验证、构建并发布兼容 ZimaOS 的 Docker 应用商店，适用于 self-hosted 和 Homelab 环境。"
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

第三方维护者可以自动化 self-hosted Docker 应用商店，而不必复制整个官方仓库。
