---
title: 应用商店开发者 FAQ
seo_title: "面向 Self-Hosted 家庭服务器的 ZimaOS Docker 应用商店 FAQ"
description: "解答 ZimaOS 和 Homelab 应用商店中的 Docker 应用 ID、多语言、构建、托管、CDN URL 与 v1 兼容问题。"
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

这些答案面向 ZimaOS、家庭服务器、Homelab 和 NAS OS 场景中的 Docker 与 self-hosted 应用商店维护者。
