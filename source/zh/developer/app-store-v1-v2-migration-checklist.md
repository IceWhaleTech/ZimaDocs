---
title: 应用商店 v1 到 v2 迁移清单
seo_title: "ZimaOS 应用商店 v1 到 v2 迁移检查清单"
description: "按照最小改动清单，把 self-hosted Docker 应用商店从 v1 迁移到适用于 ZimaOS、家庭服务器和 Homelab 的 v2。"
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

这份清单用于在家庭服务器或 Homelab 应用目录从 v1 迁移到 v2 时，保持 self-hosted Docker 应用商店兼容。
