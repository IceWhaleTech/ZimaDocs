---
title: 应用商店 CI/CD
seo_title: "面向 ZimaOS、家庭服务器和 Homelab 的 Docker 应用商店 CI/CD"
description: "通过 CI/CD 验证、构建并发布适用于 ZimaOS 家庭服务器、Homelab 和 NAS OS 的 self-hosted Docker 应用商店。"
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

使用这套 CI/CD 模型验证并发布面向 ZimaOS 家庭服务器、自托管实验环境或 Homelab 的 Docker 应用目录。
...
外部维护者推荐直接使用公开入口 `IceWhaleTech/build-appstore-action`。见 [复用官方 Actions](./app-store-github-actions)。
...
- [复用官方 Actions](./app-store-github-actions)
- [Validator 工作流](./app-store-validation-workflow)
- [Release 工作流](./app-store-build-workflow)
- [Release-store 工作流](./app-store-publishing-workflow)
