---
title: 应用商店配置
seo_title: "ZimaOS Docker 应用商店配置：标识、本地化与维护者信息"
description: "配置 ZimaOS Docker 应用商店的稳定标识、本地化文本、维护者信息和公开 URL，适用于家庭服务器与 Homelab。"
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

无论是公开商店还是私有 Homelab 目录，家庭服务器和 NAS OS 用户订阅后都应保持商店标识稳定。
