---
title: Docker Compose 与 x-casaos
seo_title: "ZimaOS Docker Compose 与 x-casaos 应用元数据参考"
description: "为 ZimaOS、家庭服务器、Homelab 和 NAS OS 中的 self-hosted 应用定义 Docker 服务与 x-casaos 元数据。"
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

当你把 Docker 服务打包成 ZimaOS 或兼容 NAS OS 的 self-hosted 应用时，请使用本页作为字段参考。
