...
2. **兼容的 ZimaBoard2 显卡**
   用于本地加速 AI 模型推理（如 NVIDIA 系列显卡）。请参考 [GPU 扩展指南](../../hardware/gpu-expansion)。
3. **6GB 或更大容量的硬盘**
...
第一次使用 Frigate？先从 [Frigate 安装指南](./frigate-setup "从 ZimaOS 应用商店安装 Frigate，实现本地 AI 摄像头监控") 的一键安装开始。
