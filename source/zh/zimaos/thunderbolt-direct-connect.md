---
title: 如何通过 Thunderbolt 线缆连接 ZimaCube
description: "通过 Thunderbolt 线缆将 ZimaCube 直接连接到 Mac 或 PC，实现 2GB/s 的传输速度。本指南介绍 ZimaOS 上的 Thunderbolt PC 直连模式。"
type: "Docs"
...
## Mac
- 如果你尚未通过 ZimaClient 连接 ZimaCube，请参阅[文档](./features#Download-the-Zima-Client)，下载并安装 [ZimaClient](https://www.zimaspace.com/zimaos/download)。初次扫描时，ZimaClient 会优先识别通过 Thunderbolt 连接的设备。
...
2. 插入线缆后，ZimaClient将自动适应并切换到Thunderbolt连接。
   - 如果你尚未通过 ZimaClient 连接 ZimaCube，请参阅[文档](./features#Download-the-Zima-Client)，下载并安装 [ZimaClient](https://www.zimaspace.com/zimaos/download)。
...
## 延伸阅读
  1. 关于如何在 macOS Finder 和 Windows 文件资源管理器中访问和修改 ZimaCube 上的文件，请参阅[更多信息](./samba-member-setup)。
  2. 关于 ZimaCube 通过 Thunderbolt 连接能够实现的最高传输速度，请参阅：[ZimaCube Thunderbolt 连接传输速度分析](../hardware/transfer-speeds-over-thunderbolt)。
