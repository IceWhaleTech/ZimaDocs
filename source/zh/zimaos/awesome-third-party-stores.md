...
| --- | --- |
| **维护者** | Cp0204 |
| **商店源** | `https://play.cuse.eu.org/store.json` |
| **链接** | [打开商店源](https://play.cuse.eu.org/store.json) · [GitHub仓库](https://github.com/Cp0204/CasaOS-AppStore-Play) |
...
| 项目 | 详情 |
| --- | --- |
| **维护者** | BigBearTechWorld |
| **商店源** | `https://cdn.jsdelivr.net/gh/bigbeartechworld/big-bear-casaos@gh-pages/store.json` |
| **链接** | [打开商店源](https://cdn.jsdelivr.net/gh/bigbeartechworld/big-bear-casaos@gh-pages/store.json) · [GitHub仓库](https://github.com/bigbeartechworld/big-bear-casaos/) |
