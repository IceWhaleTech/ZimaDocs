---
title: 安装您的硬盘
description: "ZimaCube HDD 接口使用指南。了解如何连接 SATA 和 NVMe 驱动器、检查硬盘健康状态，并在您的 NAS 上最大化存储容量。"
type: “Docs”
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
permalink: /zh/zimacube/hdd-interface-guide.html
---
## 解锁设备
1. **拆卸前面板**
...
取出第 7 个硬盘仓并做好准备。
2. **插入 PCIe SSD：**
- 对齐 M.2 接口，以 30 到 45 度角将 NVMe SSD 轻轻滑入插槽，然后将其压平。
（当听到咔哒一声卡入到位时，说明安装正确。请勿强行插入；如果无法轻松插入，请重新检查并调整对齐位置。）
...
| <center>Depends</center> | <center>SEAGATE</center> | <center>NAS</center> | <center>HDD</center> | <center>Ironwolf/Ironwolf Pro</center> | <center></center> | <center></center> | <center>Recommended for use only in Zimacube 2</center> |
