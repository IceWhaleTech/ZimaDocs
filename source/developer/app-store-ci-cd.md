...
seo_title: "CI/CD for Docker App Stores on ZimaOS and Home Servers"
description: "Validate, build, and publish a self-hosted Docker app store with CI/CD for ZimaOS home servers, homelabs, and NAS OS deployments."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

Use this CI/CD model to validate and publish a Docker app catalog for a ZimaOS home server, self-hosted lab, or broader homelab.
...
For external maintainers, the recommended public entrypoint is `IceWhaleTech/build-appstore-action`. See [Official Actions Reuse](./app-store-github-actions).
...
- [Official Actions Reuse](./app-store-github-actions)
- [Validator Workflow](./app-store-validation-workflow)
- [Release Workflow](./app-store-build-workflow)
- [Release-store Workflow](./app-store-publishing-workflow)
