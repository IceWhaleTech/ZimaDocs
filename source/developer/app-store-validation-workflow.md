---
title: App Store Validation Workflow
seo_title: "Validate Docker Apps for ZimaOS App Stores with GitHub Actions"
description: "Validate Docker Compose syntax, x-casaos metadata, and v2 build output before merging apps into a ZimaOS-compatible store."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

Validation prevents broken Docker Compose and app metadata from reaching home server or NAS OS users.
