---
title: Migrate an App Store from v1 to v2
seo_title: "Migrate a CasaOS or ZimaOS App Store from v1 to v2"
description: "Migrate a Docker app store from the CasaOS or ZimaOS v1 package format to the v2 static protocol while preserving legacy compatibility."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

Use this strategy when an existing CasaOS or ZimaOS Docker app store serves home server or homelab users and needs to move from v1 to the v2 NAS OS protocol.
