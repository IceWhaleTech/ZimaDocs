---
title: Docker Compose and x-casaos
seo_title: "Docker Compose and x-casaos Reference for ZimaOS Apps"
description: "Define Docker services and x-casaos metadata for self-hosted apps distributed through ZimaOS, home servers, homelabs, and NAS OS environments."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

Use this reference when packaging Docker services as self-hosted apps for ZimaOS or another compatible NAS OS.
