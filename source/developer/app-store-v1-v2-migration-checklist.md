---
title: App Store v1 to v2 Migration Checklist
seo_title: "ZimaOS App Store v1 to v2 Migration Checklist"
description: "Follow the minimum-change checklist for moving a self-hosted Docker app store from v1 to v2 on ZimaOS, home servers, and homelabs."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

This checklist keeps a self-hosted Docker app store compatible while moving its home server or homelab catalog from v1 to v2.
