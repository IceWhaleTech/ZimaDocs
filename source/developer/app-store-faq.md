---
title: App Store Developer FAQ
seo_title: "ZimaOS Docker App Store FAQ for Self-Hosted Home Servers"
description: "Answers about Docker app IDs, localization, builds, hosting, CDN URLs, and v1 compatibility for ZimaOS and homelab app stores."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

These answers cover common questions from maintainers of Docker and self-hosted app stores for ZimaOS, home servers, homelabs, and NAS OS environments.
