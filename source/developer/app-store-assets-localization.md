---
title: App Store Assets and Localization
seo_title: "Docker App Assets and Localization for ZimaOS App Stores"
description: "Prepare icons, thumbnails, screenshots, and localized metadata for self-hosted Docker apps distributed through ZimaOS and other NAS OS platforms."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

Consistent assets and locale data help self-hosted Docker apps render correctly across home server and NAS OS interfaces.
