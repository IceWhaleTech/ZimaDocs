---
title: App Store Build Output
seo_title: "ZimaOS App Store Build Output: Docker Compose, Metadata, and Assets"
description: "Understand generated Docker Compose files, app metadata, localized indexes, assets, and content hashes for ZimaOS app stores."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

These files are what a ZimaOS home server or homelab client consumes after the Docker app store build completes.
