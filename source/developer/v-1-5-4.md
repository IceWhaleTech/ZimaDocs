---
title: ZimaOS V1.5.4
seo_title: "ZimaOS 1.5.4 Release Notes: New Features and Updates"
description: ZimaOS V1.5.4 update adds encrypted folders, SMB pause sharing, IPv6 support, and fixes multiple security and usability issues, while optimizing storage management and file browsing for a smoother NAS experience.
type: Docs
...
---
![ZimaOS 1.5.4 Release Poster: New encrypted folder feature, enhanced SMB management, IPv6 & domain name Samba connection support, optimized storage panel and file browsing, multiple security vulnerability fixes, resolved RAID, BTRFS and Files usability bugs, improved operation prompts and error handling. Smoother, safer NAS data management experience.](https://manage.icewhale.io/api/static/docs/1785826940136_zimaos1.5.4.png)
