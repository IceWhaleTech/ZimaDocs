---
title: App Store Config
seo_title: "ZimaOS App Store Config for Docker and Self-Hosted Apps"
description: "Configure store identity, localization, maintainer metadata, and public URLs for a Docker app store used by ZimaOS home servers and homelabs."
type: Docs
author: IceWhaleTech
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---

For a public or private homelab catalog, keep the store identity stable after home server and NAS OS users subscribe.
