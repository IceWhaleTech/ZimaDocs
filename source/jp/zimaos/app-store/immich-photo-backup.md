...
seo_title: "ZimaOS の Immich：写真バックアップとストレージ設定ガイド"
description: "ZimaOS で Immich を設定し、写真と動画を自動バックアップします。インストール、モバイルアプリの同期、アルバム管理、スマート検索を詳しく説明します。"
type: "Docs"
