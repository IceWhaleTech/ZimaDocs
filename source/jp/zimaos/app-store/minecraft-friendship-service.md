...
このチュートリアルを読んでいる時点で、ZimaBoardの使い方をすでに知っている前提です：[**ZimaBoardチュートリアル**](../../../hardware/zimaboard-quick-start)
...
IPアドレスがわからない場合は、チュートリアル—["**CasaOSのIPアドレスを見つける**"](../../../help-center/find-ip-address)を参照してください。
