...
- 家族はそれぞれ自分の ZimaOS アカウントでサインインするため、各自の写真は個別のライブラリに残ります。必要なときは、**[家族の写真ライブラリ](./family-photo-library "家族全員の写真を ZimaOS にまとめた写真ライブラリを作成する")**で一緒にできます。
...
- **[写真プレビュー](./photos-preview "ZimaOS の写真をグリッド、ウォーターフォール、均等配置モードで閲覧する")** — 取り込んだライブラリを閲覧する
