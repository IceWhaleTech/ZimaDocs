---
title: PCダイレクト
seo_title: "ZimaCube PC ダイレクト：Thunderbolt ケーブルで接続"
description: "Thunderbolt または 10GbE で ZimaCube を PC に直接接続し、ローカルファイルを高速転送します。ルーターを使わない PC ダイレクトモードの設定ガイドです。"
type: Docs
...
{% note warn ヒント: %}
Thunderbolt の使用中に問題が発生した場合は、詳細を[こちら](../help-center/thunderbolt-connection-problem)で確認できます。
{% endnote %}
...
* Windows/Mac では、Zerotier を統合した [Zima APP](https://www.zimaspace.com/zimaos/download) 5 が必要です。
**手順：**
