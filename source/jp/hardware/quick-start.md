---
title: クイックスタート
seo_title: "ZimaCube クイックスタート：開梱、セットアップ、ZimaOS へのアクセス"
description: "初めて使う方向けの ZimaCube クイックスタートガイドです。3 つの簡単な手順で開梱、ハードウェア設定、ZimaOS へのアクセスを行い、ファイルの保存を始めます。"
type: Docs
