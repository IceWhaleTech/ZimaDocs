...
> **プロトコルの範囲:** このページは個別の Docker アプリの適応に焦点を当てています。現在の v2 ストアスキーマ、locale キーの大文字小文字、リポジトリ構成、ビルド出力については、[Docker Compose と x-casaos](./app-store-compose-x-casaos)、[リポジトリ構成](./app-store-repository-structure)、[ビルド出力](./app-store-build-output)を参照してください。
