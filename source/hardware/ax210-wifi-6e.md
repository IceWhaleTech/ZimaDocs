...
seo_title: "AX210 Wi-Fi on ZimaBoard: Install and Configure Guide"
...
<mark style="background-color: #fff9bd">Note:
 ...
 You can also get this version from [the provided link](../help-center/restore-factory-settings).</mark>
...
If the system does not recognize the `nmtui` command, please refer to the **Installing nmtui** section below for installation instructions.
...
4. Test your Wi-Fi network by connecting from another device.
