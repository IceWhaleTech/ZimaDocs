...
Ensure that you have referred to the [How to connect ZimaCube via Thunderbolt Cable](../zimaos/thunderbolt-direct-connect).

## High Speed Transfers via Thunderbolt Network Bridge

### 1. Samba Network Bridge Transfers
Ensure that you have referred to the help file - [Samba with Multi-User](../zimaos/samba-member-setup).
...
If you are using the Thunderbolt connection for file transfers that do not meet the above speeds, we recommend referring to the FAQ help document at the end of this article - [How to connect your ZimaCube via the Thunderbolt cable](../zimaos/thunderbolt-direct-connect). By following the steps in the troubleshooting guide you can further optimize the transfer performance and ensure you get the best possible file transfer speed experience.