...
You need at least two machines that have iperf3 installed. On ZimaOS, you can refer to this article to learn CLI. On Windows or macOS, you need to install iperf3 first [acticle](../zimaos/app-store/cli-guide)and use it in Terminal app.
**Setup the Server**
