...
- ZimaBoard 2 **auto-boots** with **pre-installed ZimaOS** and obtains an IP address automatically.
  - Visit https://www.zimaspace.com/zimaos/download to download **ZimaClient**, scan, and open the device page directly.
...
## [Sign In & Use ZimaOS](../zimaos/get-started)
...
- **Install third-party OS**: Linux distributions, OpenWrt, [UnRAID](./unraid-install), and more.
- **Enable WOL (Wake on LAN)**: Turn on in BIOS and OS (see [Tutorial：enable WOL](./wake-on-lan-setup)).
- **Use a Wi-Fi module**: Follow the driver/setup guide for ZimaOS or your chosen OS ([Tutorial：AX210 user guide](./ax210-wifi-6e)).
