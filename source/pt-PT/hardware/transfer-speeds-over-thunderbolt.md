...
Certifique-se de ter lido o [Como conectar o ZimaCube via Cabo Thunderbolt](../../zimaos/thunderbolt-direct-connect).

## Transferências de Alta Velocidade via Ponte de Rede Thunderbolt

### 1. Transferências via Ponte de Rede Samba
Certifique-se de ter consultado o arquivo de ajuda - [Samba com Multi-Usuário](../../zimaos/samba-member-setup).
