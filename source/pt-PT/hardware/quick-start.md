---
title: Início Rápido
seo_title: "Início rápido do ZimaCube: desembalar, configurar e aceder ao ZimaOS"
description: "Guia de início rápido do ZimaCube para novos utilizadores. Desembale e configure o hardware, e aceda ao ZimaOS em três passos simples para começar a guardar ficheiros."
type: Docs
...
####  Instalar um disco SATA
##### Instalar um disco rígido de 3,5 polegadas
1. **Prepare a Bandeja do Disco Rígido:**
- Remova a bandeja do disco rígido e prepare.
2. **Insira o Disco Rígido de 3,5 Polegadas:**
...
3. **Fixe o Disco Rígido:**
- Utilize os parafusos 6-32 fornecidos para fixar o disco rígido no lugar. Recomenda-se usar os parafusos que acompanham seu ZimaCube para um encaixe adequado.
- Certifique-se de que os parafusos estão apertados de forma que a superfície fique nivelada e uniforme.
##### Instalar um disco rígido de 2,5 polegadas
1. **Prepare a Bandeja do Disco Rígido:**
- Remova a bandeja do disco rígido e prepare.
2. **Insira o disco rígido de 2,5 polegadas:**
- Coloque o disco rígido de 2,5 polegadas na bandeja, alinhando os furos dos parafusos nas laterais do disco rígido com os da bandeja.
3. **Fixe o Disco Rígido:**
- Utilize os parafusos M3 fornecidos para fixar o disco rígido no lugar. Recomenda-se usar os parafusos que acompanham seu ZimaCube para um encaixe adequado.
- Certifique-se de que os parafusos estão apertados de forma que a superfície fique nivelada e uniforme.
####  Instalar um disco M.2
Como instalar um disco M.2
1. **Prepare a 7ª Baia:**
Remova a 7ª Baia e prepare.
2. **Insira o SSD M.2:**
- Alinhe a interface M.2 e deslize suavemente o SSD M.2 no slot em um ângulo de 30 a 45 graus, em seguida, empurre-o para baixo até ficar plano.
- (Você saberá que está instalado corretamente quando fizer um clique ao entrar no lugar. Não force; se não entrar facilmente, verifique e ajuste o alinhamento de acordo.)
3. **Fixe o SSD M.2:**
- Use o parafuso apropriado para fixar o SSD no lugar.
---
## Ligar
Em seguida, inicie o dispositivo
### Ligar os cabos de alimentação e rede
Porta de alimentação e cabo de rede
1. Conexão de energia, certifique-se de que está utilizando o adaptador de energia correto que veio com o ZimaCube.
- Localize a porta de alimentação: Modelo da Porta de Alimentação: DC 7.4 x 5.0 mm
- Conecte o plugue do adaptador de alimentação na porta de alimentação do ZimaCube.
2. Conexão de Rede
O ZimaCube é equipado com várias portas de rede, incluindo porta 10GbE (Gigabit Ethernet) e porta 2.5GbE (Gigabit Ethernet). A porta 10GbE é projetada para conexão de rede de alta velocidade, enquanto a porta 2.5GbE fornece funções de rede padrão.
- Modelo da porta de rede: ZimaCube: Intel i226 2.5GbE x2
ZimaCube Pro: Intel i226 2.5GbE x2; AQC113 10GbE x1
- Conecte o cabo Ethernet: Selecione a porta Ethernet apropriada de acordo com sua configuração de rede e requisitos.
...
## Iniciar sessão
### Encontrar o ZimaCube
#### 1. Ligar através do Findzima
