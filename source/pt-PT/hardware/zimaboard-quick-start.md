...
Se você descobrir que **`/casaos.local`** não pode acessar o CasaOS, por favor, utilize o endereço IP para acessar o sistema -[Tutorial Para Encontrar O Endereço IP](../../help-center/find-ip-address)
