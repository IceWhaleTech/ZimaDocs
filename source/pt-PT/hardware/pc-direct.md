---
title: PC Direct
seo_title: "ZimaCube PC Direct: ligação através de cabo Thunderbolt"
description: "Ligue o ZimaCube diretamente ao PC através de Thunderbolt ou 10GbE para transferências locais rápidas. Guia de configuração do modo PC Direct sem router."
type: Docs
tip: Do not remove this front matter block. The description field is used for the article summary; if left empty, the first paragraph will be used instead.
---
## Uma forma diferente de configurar o dispositivo
...
{% note warn Dicas: %}
Se encontrar algum problema durante a utilização do Thunderbolt, consulte informações mais detalhadas [aqui](../help-center/thunderbolt-connection-problem)
{% endnote %}
...
* Para Windows/Mac, é necessária uma [aplicação Zima](https://www.zimaspace.com/zimaos/download) 5 com Zerotier integrado.
**Passos:**
