...
- Endereço IP do seu dispositivo, usado para substituir o marcador `<ip>` nos comandos.
  ...
  Consulte o Passo 3 do [guia de inicialização](../../hardware/power-on-zimablade) para saber como encontrá-lo.
...
## Passos Detalhados (Exemplo CasaOS)
...
#### Introduzir os Parâmetros do Modelo
...
#### Definir a Política de Acesso DM
