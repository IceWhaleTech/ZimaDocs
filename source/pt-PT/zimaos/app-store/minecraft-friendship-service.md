...
Por padrão, você sabe como usar o ZimaBoard ao ler este tutorial: [**Tutorial ZimaBoard**](../../../hardware/zimaboard-quick-start)
...
![Abrir Cliente Minecraft](/images/Minecraft-Friendship-Service/minecraft-click-multiplayer.webp)
...
Se você não souber seu endereço IP, pode consultar o tutorial—["**Encontre seu Endereço IP do CasaOS**"](../../../help-center/find-ip-address)
...
![Mostrar Página do Jogo Minecraft](/images/Minecraft-Friendship-Service/minecraft-show-minecraft-game-page.webp)
