...
Usada para acelerar a inferência de modelos de IA localmente (como placas gráficas da série NVIDIA). Consulte o [guia de expansão de GPU](../../hardware/gpu-expansion).  
