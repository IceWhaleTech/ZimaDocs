...
- **[Mover dados entre unidades](./data-migration "Mova imagens Docker, dados de aplicações e pastas entre unidades no ZimaOS")** — utilize a ferramenta integrada quando uma unidade ficar cheia
