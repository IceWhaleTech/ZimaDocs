...
description: "Ligue o ZimaCube diretamente ao Mac ou PC através de um cabo Thunderbolt para atingir velocidades de transferência de 2GB/s. Guia do modo PC Direct por Thunderbolt no ZimaOS."
type: "Docs"
...
## Mac
- Se ainda não estabeleceu ligação ao ZimaCube através do ZimaClient, consulte a [documentação](./features#Download-the-Zima-Client) para transferir e instalar o [ZimaClient](https://www.zimaspace.com/zimaos/download). O ZimaClient dará prioridade aos dispositivos ligados por Thunderbolt durante a pesquisa inicial.
...
2. Após conectar o cabo, o ZimaClient se adaptará automaticamente e mudará para a conexão Thunderbolt.
   - Se ainda não estabeleceu ligação ao ZimaCube através do ZimaClient, consulte a [documentação](./features#Download-the-Zima-Client) para transferir e instalar o [ZimaClient](https://www.zimaspace.com/zimaos/download).
...
## Leitura Adicional
  1. Para aceder e modificar ficheiros do ZimaCube no Finder do macOS e no Explorador do Windows, consulte [mais informações](./samba-member-setup).
  2. Para conhecer as velocidades máximas de transferência através de Thunderbolt no ZimaCube, consulte a [análise das velocidades de transferência da ligação Thunderbolt do ZimaCube](../hardware/transfer-speeds-over-thunderbolt).
