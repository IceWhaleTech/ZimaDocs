...
Please visit https://www.zimaspace.com/zimaos/download on your host device to download the client
...
If you have the **second** computer in the office, but the zimacube is not with you, you can still use Connect ID. Find more in [here](./features#Second-host-device-access).
