...
seo_title: "AI Image Description with ZimaOS: Frigate and Ollama Setup"
...
Used for locally accelerating AI model inference (such as NVIDIA series graphics cards). See the [GPU expansion guide](../../hardware/gpu-expansion).
