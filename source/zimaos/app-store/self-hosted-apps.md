...
seo_title: "Self-Deploying Applications on ZimaBoard: linuxserver.io and More"
...
![Linuxserver Fleet](/images/Self-Deploying-Applications/application-linuxserver-fleet1.webp)
...
![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-docker-cli.webp)
...
![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps1.webp)

![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps2.webp)

![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps3.webp)

![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps4.webp)

### Copy Apprise API Docker Cli 

![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps5.webp)

### Past Apprise API Docker Cli 

![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps6.webp)

### Add Web UI Port

![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps7.webp)

### Wait for Installation

This can take a few minutes

![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-install-apps8.webp)

### Successful Installation and Click-to-Use

![Copy Appriseapi Cli](/images/Self-Deploying-Applications/application-using-appriseapi.webp)
